...
INSERT INTO `profile` VALUES (1,1,1,'User','The user can view and perform tasks and can start a new case of a process.',1510771556874,-1,1510772013040,-1),(1,2,1,'Administrator','The administrator can install a process, manage the organization, and handle some errors (for example, by replaying a task).',1510771556925,-1,1510771886563,-1);
