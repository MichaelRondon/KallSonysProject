...
--
-- Table structure for table `proc_parameter`
--
...
--
-- Dumping data for table `proc_parameter`
--

LOCK TABLES `proc_parameter` WRITE;
/*!40000 ALTER TABLE `proc_parameter` DISABLE KEYS */;
/*!40000 ALTER TABLE `proc_parameter` ENABLE KEYS */;
UNLOCK TABLES;
