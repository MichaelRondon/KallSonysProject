...
--
-- Dumping data for table `connector_instance`
--

LOCK TABLES `connector_instance` WRITE;
/*!40000 ALTER TABLE `connector_instance` DISABLE KEYS */;
/*!40000 ALTER TABLE `connector_instance` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-15 18:33:09
