...
--
-- Dumping data for table `ref_biz_data_inst`
--

LOCK TABLES `ref_biz_data_inst` WRITE;
/*!40000 ALTER TABLE `ref_biz_data_inst` DISABLE KEYS */;
/*!40000 ALTER TABLE `ref_biz_data_inst` ENABLE KEYS */;
UNLOCK TABLES;
