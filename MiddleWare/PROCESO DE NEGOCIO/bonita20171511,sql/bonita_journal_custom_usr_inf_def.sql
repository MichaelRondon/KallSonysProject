...
--
-- Dumping data for table `custom_usr_inf_def`
--

LOCK TABLES `custom_usr_inf_def` WRITE;
/*!40000 ALTER TABLE `custom_usr_inf_def` DISABLE KEYS */;
/*!40000 ALTER TABLE `custom_usr_inf_def` ENABLE KEYS */;
UNLOCK TABLES;
