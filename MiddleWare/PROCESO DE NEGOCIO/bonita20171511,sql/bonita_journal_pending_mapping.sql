...
--
-- Dumping data for table `pending_mapping`
--

LOCK TABLES `pending_mapping` WRITE;
/*!40000 ALTER TABLE `pending_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `pending_mapping` ENABLE KEYS */;
UNLOCK TABLES;
