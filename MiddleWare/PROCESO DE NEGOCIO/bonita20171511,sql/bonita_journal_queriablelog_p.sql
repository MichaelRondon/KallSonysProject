...
--
-- Dumping data for table `queriablelog_p`
--

LOCK TABLES `queriablelog_p` WRITE;
/*!40000 ALTER TABLE `queriablelog_p` DISABLE KEYS */;
/*!40000 ALTER TABLE `queriablelog_p` ENABLE KEYS */;
UNLOCK TABLES;
