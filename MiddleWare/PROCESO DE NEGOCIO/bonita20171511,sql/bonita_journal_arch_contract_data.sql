...
--
-- Dumping data for table `arch_contract_data`
--

LOCK TABLES `arch_contract_data` WRITE;
/*!40000 ALTER TABLE `arch_contract_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `arch_contract_data` ENABLE KEYS */;
UNLOCK TABLES;
