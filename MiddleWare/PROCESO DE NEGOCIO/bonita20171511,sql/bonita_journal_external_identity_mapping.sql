...
--
-- Dumping data for table `external_identity_mapping`
--

LOCK TABLES `external_identity_mapping` WRITE;
/*!40000 ALTER TABLE `external_identity_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `external_identity_mapping` ENABLE KEYS */;
UNLOCK TABLES;
