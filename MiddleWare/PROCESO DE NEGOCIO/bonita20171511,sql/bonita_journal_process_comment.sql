...
--
-- Dumping data for table `process_comment`
--

LOCK TABLES `process_comment` WRITE;
/*!40000 ALTER TABLE `process_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `process_comment` ENABLE KEYS */;
UNLOCK TABLES;
