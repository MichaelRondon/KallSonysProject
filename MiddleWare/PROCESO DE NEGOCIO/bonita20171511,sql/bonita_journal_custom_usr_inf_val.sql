...
--
-- Dumping data for table `custom_usr_inf_val`
--

LOCK TABLES `custom_usr_inf_val` WRITE;
/*!40000 ALTER TABLE `custom_usr_inf_val` DISABLE KEYS */;
/*!40000 ALTER TABLE `custom_usr_inf_val` ENABLE KEYS */;
UNLOCK TABLES;
