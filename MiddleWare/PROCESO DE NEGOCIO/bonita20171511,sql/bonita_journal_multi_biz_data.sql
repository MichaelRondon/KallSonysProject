...
--
-- Dumping data for table `multi_biz_data`
--

LOCK TABLES `multi_biz_data` WRITE;
/*!40000 ALTER TABLE `multi_biz_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `multi_biz_data` ENABLE KEYS */;
UNLOCK TABLES;
