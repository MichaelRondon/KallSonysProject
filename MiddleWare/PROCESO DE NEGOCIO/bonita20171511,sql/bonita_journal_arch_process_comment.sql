...
CREATE TABLE `arch_process_comment` (
  ...
  KEY `idx1_arch_process_comment` (`sourceObjectId`,`tenantid`),
...
--
-- Dumping data for table `arch_process_comment`
--

LOCK TABLES `arch_process_comment` WRITE;
/*!40000 ALTER TABLE `arch_process_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `arch_process_comment` ENABLE KEYS */;
UNLOCK TABLES;
