...
--
-- Dumping data for table `processsupervisor`
--

LOCK TABLES `processsupervisor` WRITE;
/*!40000 ALTER TABLE `processsupervisor` DISABLE KEYS */;
/*!40000 ALTER TABLE `processsupervisor` ENABLE KEYS */;
UNLOCK TABLES;
