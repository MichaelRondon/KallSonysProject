...
--
-- Dumping data for table `processcategorymapping`
--

LOCK TABLES `processcategorymapping` WRITE;
/*!40000 ALTER TABLE `processcategorymapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `processcategorymapping` ENABLE KEYS */;
UNLOCK TABLES;
