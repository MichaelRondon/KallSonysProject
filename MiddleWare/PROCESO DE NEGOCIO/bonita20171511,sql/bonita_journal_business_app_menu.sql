...
--
-- Dumping data for table `business_app_menu`
--

LOCK TABLES `business_app_menu` WRITE;
/*!40000 ALTER TABLE `business_app_menu` DISABLE KEYS */;
/*!40000 ALTER TABLE `business_app_menu` ENABLE KEYS */;
UNLOCK TABLES;
