...
--
-- Dumping data for table `arch_data_instance`
--

LOCK TABLES `arch_data_instance` WRITE;
/*!40000 ALTER TABLE `arch_data_instance` DISABLE KEYS */;
/*!40000 ALTER TABLE `arch_data_instance` ENABLE KEYS */;
UNLOCK TABLES;
