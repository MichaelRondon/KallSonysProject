...
--
-- Dumping data for table `pdependencymapping`
--

LOCK TABLES `pdependencymapping` WRITE;
/*!40000 ALTER TABLE `pdependencymapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `pdependencymapping` ENABLE KEYS */;
UNLOCK TABLES;
