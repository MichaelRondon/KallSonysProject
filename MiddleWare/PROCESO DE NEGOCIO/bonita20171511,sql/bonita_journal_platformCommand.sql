...
--
-- Dumping data for table `platformCommand`
--

LOCK TABLES `platformCommand` WRITE;
/*!40000 ALTER TABLE `platformCommand` DISABLE KEYS */;
/*!40000 ALTER TABLE `platformCommand` ENABLE KEYS */;
UNLOCK TABLES;
